  ...
  return (
    ...
    <Swiper
      ...
      <div>
       ...
       <div className="h-60">
         <img src="https://homepress.stylemixthemes.com/main/wp-content/uploads/sites/3/2021/03/alberto-castillo-q-mx4mSkK9zeo-unsplash-min-min-760x510.jpg" alt="" className='h-full w-full' />
       </div>
         <div className="px-1">
             {/* --------- Product Content ---------- */}
         <div className="">
