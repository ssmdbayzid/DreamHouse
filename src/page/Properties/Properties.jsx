    ...
    <section className='section '>
       ...
       <Loader />
        ...
        <div className="container">
          ...
          type="button" className=" md:hidden  p-2 text-gray-400 hover:text-gray-500 sm:ml-6 ">
        ...
        <div className="hidden top-20 sticky md:block md:col-span-2 lg:col-span-1 h-screen">
